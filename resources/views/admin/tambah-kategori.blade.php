        ...
        <div class="mb-16 font-poppins">
            <div class="flex justify-between items-center w-full mb-3 text-[10px]">
                ...
                <button
                    ...
                    data-modal-target="addKategori" data-modal-show="addKategori"><i class='bx bx-plus'
                        class="text-xs md:text-lg"></i><span>Tambah Kategori</span></button>
                <button
                                ...
                                <tr class="bg-white hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div id="EditKategori-{{ $item->id }}" tabindex="-1" aria-hidden="true"
                                            ...
                                            <div class="relative w-full max-w-2xl bg-white shadow-lg rounded-xl">
                                                <!-- Modal content -->
                                                <form action="{{ route('update-data-kategori', $item->id) }}"
                                                    method="POST" enctype="multipart/form-data" class="relative">
                                                    @csrf
                                                    <!-- Modal header -->
                                                    <div
