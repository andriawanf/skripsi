        ...
        <div class="font-poppins">
            <div class="flex justify-between items-center w-full mb-3 text-[10px]">
                ...
                <div class="flex flex-row space-x-2">
                    <button class="px-4 py-2 bg-gradient-to-r from-[#B4E080] to-[#8AC054] hover:bg-gradient-to-br text-sm font-medium rounded-lg flex flex-row space-x-2 items-center" data-modal-target="addGuru" data-modal-show="addGuru">
                        <i class='bx bx-plus' class="text-lg" ></i>
                        <span>Tambah Data Guru</span>
                    </button>
                    <div class="px-4 py-2 bg-gradient-to-r from-[#B4E080] to-[#8AC054] hover:bg-gradient-to-br text-sm font-medium rounded-lg flex flex-row space-x-2 justify-center items-center">
