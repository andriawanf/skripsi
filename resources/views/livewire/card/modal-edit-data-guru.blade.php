<div id="editUserModal" tabindex="-1" aria-hidden="true" wire:ignore.self
    ...
    <div class="relative w-full max-w-2xl bg-white rounded-xl shadow-lg">
        <!-- Modal content -->
        <form class="relative" wire:submit.prevent='updateDataGuru'>
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="text" name="nip" id="nip" wire:model='nip'
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="text" name="jabatan" id="jabatan" wire:model='jabatan'
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="text" name="pangkat" id="pangkat" wire:model='pangkat'
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Guru" required>
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <label for="saldo_cuti"
                            ...
                            Cuti</label>
                        <input type="number" name="saldo_cuti" id="saldo_cuti" wire:model='saldo_cuti'
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div class="col-span-6 sm:col-span-6">
                        <label for="foto" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Foto
                            Profil</label>
                        <input name="foto" wire:model='foto'
