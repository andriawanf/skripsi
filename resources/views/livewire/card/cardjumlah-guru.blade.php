<div class="w-full h-fit relative overflow-hidden bg-gradient-to-tr from-[#4B89DA] to-[#73B1F4] rounded-2xl shadow-md border border-[#4B89DA]">
    ...
    <div class="flex flex-row space-x-4 sm:space-x-5 md:space-x-6 lg:space-x-7 justify-center items-center space-y-1 sm:space-y-2 p-4 mt-2 sm:mt-1 w-full h-auto z-10 relative">
        <div class="py-1 px-1.5 sm:py-1.5 sm:px-3 bg-white/20 shadow-md border border-white/25 backdrop-blur-sm rounded-xl">
            <i class='bx bxs-group bx-md sm:bx-lg text-[#1e1e1e]'></i>
        </div>
        <div class="flex flex-col text-[#1e1e1e] space-y-1">
            <p class="text-xs sm:text-lg font-semibold">Jumlah Guru</p>
            <h1 class="text-2xl sm:text-2xl md:text-4xl font-bold">{{ $jumlahGuru }}</h1>
        </div>
    </div>
</div>
