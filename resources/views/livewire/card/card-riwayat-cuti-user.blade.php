{{-- <div class="w-full h-auto flex flex-col justify-center items-center space-y-2 p-4 bg-gradient-to-tr from-[#73B1F4] to-[#4B89DA] rounded-xl font-poppins">
    <p class="text-xs font-semibold">Riwayat Cuti</p>
    <h1 class="text-3xl font-bold">{{ $totalCuti }}</h1>
    <p class="text-xs font-semibold">Per Tahun</p>
</div> --}}
<div class="w-full h-auto relative overflow-hidden bg-gradient-to-tr from-[#4B89DA] to-[#73B1F4] rounded-2xl shadow-md border border-[#4B89DA]">
    ...
    <div class="flex flex-row space-x-4 sm:space-x-6 justify-center items-center space-y-1 sm:space-y-2 p-4 mt-2 sm:mt-1 w-full h-auto z-10 relative">
        ...
        <div class="flex flex-col text-[#1e1e1e] space-y-1">
            <p class="text-xs sm:text-lg font-semibold">Riwayat Cuti Anda</p>
            <h1 class="text-2xl sm:text-2xl md:text-4xl font-bold">{{ $totalCuti }}</h1>
        </div>
    </div>
</div>