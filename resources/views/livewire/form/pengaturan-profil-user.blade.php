    ...
    <div class="mb-6">
        <div class="mb-6">
            ...
            <div class="flex flex-col sm:flex-row gap-3 items-center justify-center w-full">
                @if ($foto)
                    <img src="{{ $foto->temporaryUrl() }}" alt="foto profil"
        ...
        <div class="mb-6">
            ...
            <div class="relative">
                <input type="password" id="password-input" wire:model='passUser'
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="********" required>
                <button type="button" class="absolute top-1 bottom-0 right-2.5 text-xl font-medium"
                    onclick="togglePasswordVisibility()"><i id="password-toggle-icon" class='bx bxs-show'></i></button>
            </div>
        </div>
