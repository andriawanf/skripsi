...
<body>
    <main class="px-3 bg-[#F4F6F9] min-h-screen py-9 selection:bg-[#8AC054] selection:text-white">
        <div class="w-full flex flex-col justify-center items-center mb-9">
        ...
        <div class="flex flex-col space-y-6 sm:mx-64 sm:mt-20">
            <div>
                <h1 class="font-poppins font-semibold text-2xl text-gray-900">Register</h1>
